...
/**
 * <a href=https://github.com/mattbdean/JRAW-Android/blob/master/example-app/src/main/java/net/dean/jraw/android/example/NewUserActivity.java>Thanks mattbdean</a><br>
 *
...
public class NewUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final StatefulAuthHelper helper = LiveThreadApplication.getAccountHelper().switchToNewUser();
